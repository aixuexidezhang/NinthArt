...
- There are 312 sprites in total.
- An alternative gameboy palette (4 colours) is available for 127 sprites.
...
Contact:
--------
If you have any questions or feedback, please email me at geonjaha@hotmail.com or leave a comment on the product page. If you would like specific sprites or small alterations to these sprites for your game, please get in contact.
...
~ V4 ~
Sprites:
- Added 39 sprites (14 Gameboy)
- Refined 2 existing sprites
Others:
- Updated preview image
- Added grid reference spritesheets

~ V3.2 ~
Sprites:
- Added 20 sprites (6 Gameboy)
- Refined 1 existing sprites
Others:
- Updated preview image
...
- Refined 10 existing sprites (4 Gameboy)
Others:
- Updated preview image
